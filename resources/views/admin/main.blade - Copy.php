...
<script type="text/javascript">
    ...
    function getSidebar(role) {
        $.ajax({
            ...
            type: "GET",
            success: function (response) {
                let app = document.querySelector('.side-menu');
                $(app).append('<li><h3>Main</h3></li>');
                ...
                if (response.sidebar.length > 0) {
                    for (let i = 0; i < response.sidebar.length; i++) {
                        ...
                        if (sidebar[i]['parent'] == null && sidebar[i]['url'] != null) {
                            $(app).append("<li>" + '<a class="side-menu__item" href="' + base_url + '/' + url + '"><i class="side-menu__icon ' + sidebar[i]['icon'] + '"></i><span class="side-menu__label">' + sidebar[i]['name'] + '</span></a>' + "</li>");
                            ...
                            $(app).append("<li class='slide'>" + '<a class="side-menu__item submenu" data-toggle="slide" href="#" ><i class="side-menu__icon ' + sidebar[i]['icon'] + '"></i><span class="side-menu__label">' + sidebar[i]['name'] + '</span><i class="angle fa fa-angle-right"></i></a><ul class="slide-menu">');
                            ...
                            let subapp = document.querySelector('.slide-menu');
                            for (let j = 0; j < response.submenu.length; j++) {
                                ...
                                if (submenu[j]['parent'] == sidebar[i]['id'] && submenu[j]['url'] != null) {
                                    $(subapp).append("<li>" + '<a class="slide-item" href="' + base_url + '/' + suburl + '"><i class="' + submenu[j]['icon'] + '"></i><span class="side-menu__label ml-1">' + submenu[j]['name'] + '</span></a>' + "</li>");
    ...
    //     console.log(checkElement.is(dropdownContent.className))
